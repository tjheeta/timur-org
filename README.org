...
**** DONE Bugs - adil file has extra newline at start
     CLOSED: [2017-08-16 Wed 19:18]
**** Bugs - date format should be the same
**** Bugs - schedule time interval + repeat - is this done later?
**** TODO - Properties - parse, store, and write
**** Parse file uuid from metadata
**** Parse properties to get version and id into object 
...
#+CAPTION: Clock summary at [2017-08-16 Wed 19:27]
| Headline                                           | Time    |       |       |       |      |
|----------------------------------------------------+---------+-------+-------+-------+------|
| *Total time*                                       | *21:27* |       |       |       |      |
|----------------------------------------------------+---------+-------+-------+-------+------|
