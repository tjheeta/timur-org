defmodule Ttl.Parse do
  ...
  defmodule Object do
    defstruct level: 1, title: "", content: "", closed: nil, scheduled: nil, deadline: nil, state: "", pri: "", version: 1, defer_count: 0, min_time_needed: 5, time_spent: 0, is_public: 0, tags: "", subobjects: []
  end
