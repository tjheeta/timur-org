defmodule Ttl.Web.UserControllerTest do
  use Ttl.Web.ConnCase

  alias Ttl.Accounts

  @create_attrs %{access_token: "some access_token", email: "some email"}
  @update_attrs %{access_token: "some updated access_token", email: "some updated email"}
  @invalid_attrs %{access_token: nil, email: nil}
