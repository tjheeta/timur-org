...
[[file:scratch.ex::##%20Last%20working%20state][Last working state]]
...
***** DONE Make it into a function 
      ...
      :END:
***** Maybe use ecto.multi to make a clean transaction
***** Make a solid decision on what to do on failed update / version conflict
      :LOGBOOK:
...
**** regenerate file from database - with uuid's
***** Create the document and document_id
**** Parse logbook and properties to get version and id into object
**** make an interval data structure for scheduling and bin-packing calendar
**** Parse the schedule properly into the interval structure
**** [[file:scratch.ex::###%20Versioning%20notes][versioning notes]]
...
#+CAPTION: Clock summary at [2017-08-15 Tue 21:39]
| Headline                                         | Time    |       |       |       |      |
|--------------------------------------------------+---------+-------+-------+-------+------|
| *Total time*                                     | *14:53* |       |       |       |      |
|--------------------------------------------------+---------+-------+-------+-------+------|
