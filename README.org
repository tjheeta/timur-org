...
***** Add api key to plug
      :LOGBOOK:
      CLOCK: [2017-09-03 Sun 10:00]
      :END:

#+BEGIN_SRC shell :results output
#    curl -H "x-api-client:de4927d9-a099-4ec8-bb99-4f69888acb34" -H "x-api-key:somekey" "http://localhost:4000/api/v1" 
...
**** Need api_token field - forget having a separate table for now
**** Sync
