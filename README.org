...
:END:
[[file:lib/ttl/parse/parse.ex::#%20this%20is%20working%20but%20subsequent%20id's%20are%20not%20being%20updated][Current state]]
***** Need to use ecto.multi to make a clean transaction
**** Parse logbook and properties
...
#+CAPTION: Clock summary at [2017-08-14 Mon 19:54]
| Headline                                        | Time   |      |      |      |
|-------------------------------------------------+--------+------+------+------|
| *Total time*                                    | *6:17* |      |      |      |
|-------------------------------------------------+--------+------+------+------|
